...
public class ECommerceDbContext : DbContext
{
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<Product>(entity =>
        {
            ...
            entity.Property(e => e.SearchVector).HasComputedColumnSql("([Name] + ' ' + ISNULL([Description],''))", stored: true);
        ...
        modelBuilder.Entity<Category>(entity =>
        {
            ...
            entity.HasIndex(e => e.ParentCategoryId).HasDatabaseName("IX_Categories_ParentCategoryId");
        });
        // Customer configuration
        modelBuilder.Entity<Customer>(entity =>
        {
            entity.HasKey(e => e.CustomerId);
            entity.Property(e => e.CustomerId).UseIdentityColumn(1, 1);
        ...
        modelBuilder.Entity<Order>(entity =>
        {
            ...
            entity.Property(e => e.OrderDate).HasColumnType("datetime2").HasDefaultValueSql("GETUTCDATE()");
            entity.Property(e => e.TotalAmount).HasColumnType("decimal(18,2)").IsRequired();
            entity.Property(e => e.TaxAmount).HasColumnType("decimal(18,2)").IsRequired();
            entity.Property(e => e.Status).HasMaxLength(20).HasDefaultValue("Pending");
            entity.Property(e => e.ShippingAddress).HasMaxLength(500);
            // Foreign key relationship
            entity.HasOne(e => e.Customer).WithMany(c => c.Orders).HasForeignKey(e => e.CustomerId).OnDelete(DeleteBehavior.Restrict);
        ...
        modelBuilder.Entity<OrderItem>(entity =>
        {
            ...
            // SQL Server computed column
            entity.Property(e => e.LineTotal).HasColumnType("decimal(18,2)").HasComputedColumnSql("([Quantity] * [UnitPrice])", stored: true);
            ...
            entity.HasIndex(e => new { e.OrderId, e.ProductId }).HasDatabaseName("IX_OrderItems_OrderId_ProductId");
        });
        // AuditLog configuration
        modelBuilder.Entity<AuditLog>(entity =>
        {
            entity.HasKey(e => e.AuditLogId);
            entity.Property(e => e.AuditLogId).UseIdentityColumn(1, 1);
            ...
            entity.Property(e => e.Timestamp).HasColumnType("datetime2").HasDefaultValueSql("GETUTCDATE()");
            entity.Property(e => e.OldValues).HasColumnType("nvarchar(max)");
            entity.Property(e => e.NewValues).HasColumnType("nvarchar(max)");
            // Index for audit queries
            entity.HasIndex(e => new { e.TableName, e.Timestamp }).HasDatabaseName("IX_AuditLog_TableName_Timestamp");
        });
    }
    ...
    public async Task<List<Product>> GetProductsByCategoryAsync(int categoryId, int pageSize, int pageNumber)
    {
        ...
        return await Products.FromSqlRaw("EXEC GetProductsByCategory @CategoryId, @PageSize, @PageNumber", categoryParam, pageSizeParam, pageNumberParam).ToListAsync();
    }
    ...
    public async Task<int> ProcessOrderAsync(int customerId, string orderItemsJson, decimal taxRate = 0.0825m)
    {
        ...
        var result = await Database.SqlQueryRaw<int>("EXEC ProcessOrder @CustomerId, @OrderItems, @TaxRate", customerParam, orderItemsParam, taxRateParam).FirstOrDefaultAsync();
        return result;
    }
}
